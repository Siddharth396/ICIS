namespace Infrastructure.Configuration
{
    ...
    public static class ConfigurationExtensions
    {
        ...
        public static MongoUrl GetMongoDbUrl(this IConfiguration configuration)
        {
            var options = configuration.GetOptions<MongoDbOptions>();
            return MongoUrl.Create(options.BuildConnectionString(configuration));
        }
        ...
        public static bool IsAuthoring(this IConfiguration configuration)
        {
            return configuration.GetValue<bool?>("IsAuthoring", false) ?? false;
        }
        ...
        public static string GetDlhRecordSource(this IConfiguration configuration)
        {
            return configuration.GetValue<string?>("DlhRecordSource", string.Empty) ?? string.Empty;
        }
    }
}