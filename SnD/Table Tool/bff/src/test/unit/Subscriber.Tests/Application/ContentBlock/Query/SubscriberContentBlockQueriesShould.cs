namespace Subscriber.Tests.Application.ContentBlock.Query
{
    ...
    using Subscriber.Application.ContentBlock.Query;
    ...
    public class SubscriberContentBlockQueriesShould
    {
        ...
        public SubscriberContentBlockQueriesShould(SubscriberStubFixture fixture)
        {
        ...
        public async Task ReturnValidResponse_When_FetchingContentBlockConfigurationWithValidContentBlockIdAndVersion()
        {
            ...
            // Act
            var response = await contentBlockQueries.GetContentBlock(resolverContext.Object, contentBlockRequest.Object, validationService.Object, contentBlockService.Object);
