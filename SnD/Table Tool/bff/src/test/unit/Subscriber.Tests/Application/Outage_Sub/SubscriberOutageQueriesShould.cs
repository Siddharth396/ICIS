namespace Subscriber.Tests.Application.Outage_Sub
{
    ...
    using Subscriber.Application.Outage_Sub;
    ...
    public class SubscriberOutageQueriesShould
    {
        ...
        public SubscriberOutageQueriesShould(SubscriberStubFixture fixture)
        {
