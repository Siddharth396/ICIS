namespace Subscriber.Tests.Application.Capacity
{
    ...
    using Subscriber.Application.Capacity_Sub;
    ...
    public class SubScriberCapacityQueriesShould
    {
        ...
        public SubScriberCapacityQueriesShould(SubscriberStubFixture fixture)
        {
