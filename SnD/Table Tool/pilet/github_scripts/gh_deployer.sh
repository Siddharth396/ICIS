...
WORKFLOW_IDENTIFIER="snd-table-pilet-${WORKFLOW_IDENTIFIER}"
echo "Workflow Identifier = $WORKFLOW_IDENTIFIER"

if [ -z "${IMAGE_REPO}" ]
then
  IMAGE_REPO="artifacts.cha.rbxd.ds/sbmfe/sbmfe-supply-and-demand-pilet${PILET_TYPE}"
fi
...
CI_PATH="LexisNexis-RBA/dsg-icis-snd-table-pilet"
